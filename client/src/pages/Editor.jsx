...
// //   const { portfolioData, loadPortfolio, clearPortfolio } = usePortfolio();
...
// //           <h2 className="font-semibold text-gray-800 text-sm truncate max-w-[200px]">{portfolioData?.title}</h2>
// //         </div>
...
// //           <h3 className="text-lg font-semibold text-gray-800 mb-2">Editor is ready!</h3>
// //           <p className="text-gray-500">Full section forms and live preview coming in Step 5.</p>
// //           <p className="text-sm text-gray-400 mt-2">Portfolio ID: <code className="bg-gray-100 px-2 py-0.5 rounded">{id}</code></p>
// //         </div>
// //       </div>
// //     </div>
// //   );
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-16 z-40">
        ...
        <div className="flex items-center gap-2">
          <Button variant="secondary" size="sm" className="lg:hidden" onClick={() => setShowPreview(!showPreview)}>
            {showPreview ? "✏️ Edit" : "👁 Preview"}
          </Button>
        ...
        <div className={`flex-1 bg-gray-100 ${showPreview ? "flex" : "hidden lg:flex"} flex-col`}>
          <div className="bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between">
            <span className="text-xs font-medium text-gray-500">
              Live Preview — <span className="capitalize">{portfolioData?.template || "minimal"}</span> Template
            </span>
            <div className="flex items-center gap-1">
              <span className="w-2.5 h-2.5 rounded-full bg-red-400"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-yellow-400"></span>
