...
export default function HeroForm() {
  ...
  const handleImageUpload = async (e) => {
    ...
    setUploading(true);
    try {
      const data = await uploadImageToCloudinary(file, "profiles");
      updateSection("hero", { profileImage: data.url });
      toast.success("Profile photo uploaded! ✓");
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <label className={`cursor-pointer inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border transition ${
              uploading
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className={labelClass}>Role / Title</label>
            <input type="text" name="role" value={hero.role || ""} onChange={handleHero}
              placeholder="Full Stack Developer" className={inputClass} />
          </div>
          <div>
            <label className={labelClass}>Tagline</label>
            <input type="text" name="tagline" value={hero.tagline || ""} onChange={handleHero}
              placeholder="I build things for the web" className={inputClass} />
          </div>
          <div>
            <label className={labelClass}>Short Bio</label>
            <textarea name="bio" value={hero.bio || ""} onChange={handleHero} rows={3}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="text" name="location" value={hero.location || ""} onChange={handleHero}
                placeholder="New York, USA" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Email</label>
          ...
          <div>
            <label className={labelClass}>Phone</label>
            <input type="text" name="phone" value={hero.phone || ""} onChange={handleHero}
      ...
      <div>
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className={labelClass}>Primary Button Text</label>
              <input type="text" name="ctaText" value={hero.ctaText || ""} onChange={handleHero}
                placeholder="View My Work" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Primary Button Link</label>
              <input type="text" name="ctaLink" value={hero.ctaLink || ""} onChange={handleHero}
                placeholder="#projects" className={inputClass} />
            </div>
          </div>
          <div>
            <label className={labelClass}>Secondary Button Text</label>
            <input type="text" name="ctaSecondaryText" value={hero.ctaSecondaryText || ""} onChange={handleHero}
              placeholder="Download Resume" className={inputClass} />
          </div>
        </div>
      </div>
